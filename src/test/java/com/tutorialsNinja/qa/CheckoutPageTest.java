...
@BeforeMethod
    ...
    public void cartPage() {
     ...
     public void CheckoutPage() {
         ...
         checkoutPage.registerAccountOnCheckoutPage();
         ...
         checkoutPage.enterPaymentPassword("12345");
         checkoutPage.enterPaymentConfirmPassword("12345");
         //checkoutPage.enterPaymentPassword("password123");
         //checkoutPage.enterPaymentConfirmPassword(expectedResult("(paymentConfPwd"));
         //checkoutPage.enterPaymentConfirmPassword("password123");
         waitFor(10);
